 ...
 */
#ifndef QSAQMAODVROUTINGPROTOCOL_H
#define QSAQMAODVROUTINGPROTOCOL_H

#include "qsaqmaodv-dpd.h"
#include "qsaqmaodv-neighbor.h"
#include "qsaqmaodv-packet.h"
#include "qsaqmaodv-rqueue.h"
 ...
 * \ingroup qsaqmaodv
 *
 * \brief QSAQMAODV routing protocol
 */
class RoutingProtocol : public Ipv4RoutingProtocol
{
  public:
    ...
    static const uint32_t QSAQMAODV_PORT;
  ...
  /// QSAQMAODV: periodic adaptation tick (ε-decay + α-recompute + reward-weight update)
  void PeriodicAdaptiveTick();
  /// QSAQMAODV: read residual energy fraction from BasicEnergySource
  ...
  /// QSAQMAODV: Self-adaptive Q-table
  QTable m_qtable;
  /// QSAQMAODV: max paths
  uint32_t m_maxPaths{3};
  /// QSAQMAODV: initial Q-learning params (before adaptation)
  double m_alpha0{0.5};
  double m_gamma{0.9};
  ...
  double m_w2{0.4};
  double m_w3{0.1};
  /// QSAQMAODV: adaptive controller params
  double m_lambda{0.1};
  ...
  double m_qsW4{0.20};
  double m_queueHighThreshold{0.70};
  double m_queueLowThreshold{0.30};
  ...
  private:
     ...
     */
    void RecvQsaqmaodv(Ptr<Socket> socket);
    /**
     * Receive RREQ
     * \param p packet
...
#endif /* QSAQMAODVROUTINGPROTOCOL_H */
