 ...
 */
#ifndef QSAQMAODVPACKET_H
#define QSAQMAODVPACKET_H
...
enum MessageType
{
    QSAQMAODVTYPE_RREQ = 1,    //!< QSAQMAODVTYPE_RREQ
    QSAQMAODVTYPE_RREP = 2,    //!< QSAQMAODVTYPE_RREP
    QSAQMAODVTYPE_RERR = 3,    //!< QSAQMAODVTYPE_RERR
    QSAQMAODVTYPE_RREP_ACK = 4 //!< QSAQMAODVTYPE_RREP_ACK
};

/**
 * \ingroup qsaqmaodv
 * \brief QSAQMAODV types
 */
class TypeHeader : public Header
{
  public:
    /**
     * constructor
     * \param t the QSAQMAODV RREQ type
     */
    TypeHeader(MessageType t = QSAQMAODVTYPE_RREQ);
