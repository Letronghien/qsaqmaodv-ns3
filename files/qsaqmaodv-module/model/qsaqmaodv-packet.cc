...
{
    static TypeId tid = TypeId("ns3::qsaqmaodv::TypeHeader")
                            .SetParent<Header>()
...
{
    static TypeId tid = TypeId("ns3::qsaqmaodv::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("Qsaqmaodv")
...
{
    static TypeId tid = TypeId("ns3::qsaqmaodv::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("Qsaqmaodv")
...
{
    static TypeId tid = TypeId("ns3::qsaqmaodv::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("Qsaqmaodv")
...
{
    static TypeId tid = TypeId("ns3::qsaqmaodv::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("Qsaqmaodv")
