 ...
 */
#ifndef QSAQMAODV_RQUEUE_H
#define QSAQMAODV_RQUEUE_H
...
/**
 * \ingroup qsaqmaodv
 * \brief QSAQMAODV route request queue
 *
 * Since QSAQMAODV is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
  public:
