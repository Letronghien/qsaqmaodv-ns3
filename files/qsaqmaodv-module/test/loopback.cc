 ...
 * \ingroup qsaqmaodv
 *
 * \brief QSAQMAODV loopback UDP echo test case
 */
 ...
 *
 * \brief QSAQMAODV Loopback test suite
 */
class QsaqmaodvLoopbackTestSuite : public TestSuite
{
  public:
    QsaqmaodvLoopbackTestSuite()
        : TestSuite("routing-qsaqmaodv-loopback", SYSTEM)
    {
        SetDataDir(NS_TEST_SOURCEDIR);
        // UDP Echo loopback test case
        AddTestCase(new LoopbackTestCase(), TestCase::QUICK);
    }
} g_qsaqmaodvLoopbackTestSuite; ///< the test suite
